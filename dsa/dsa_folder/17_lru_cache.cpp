...
int main() {
    ...
    lru.put(1, 150);  // Update existing
    lru.print();  // [1:150] [4:400] [3:300]
    ...
    lfu.put(3, 30);  // Evicts key 2 (freq=1, LRU among freq=1)
    cout << "Get 2: " << lfu.get(2) << endl;  // -1 (evicted)
    cout << "Get 3: " << lfu.get(3) << endl;  // 30

    lfu.put(4, 40);  // Evicts key 3 (freq=1)
    cout << "Get 1: " << lfu.get(1) << endl;  // 10
    cout << "Get 3: " << lfu.get(3) << endl;  // -1 (evicted)
    cout << "Get 4: " << lfu.get(4) << endl;  // 40
